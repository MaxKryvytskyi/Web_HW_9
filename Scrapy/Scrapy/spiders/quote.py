...
class QuoteSpider(scrapy.Spider):
    name = "quote"
    custom_settings = {"FEED_FORMAT" : "json", "FEED_URI" : "Load_mongoDB/Json/quotes.json"}
    ...
    def parse(self, response):
        ...
        for data in datas:
            yield { "tags": data.xpath("div[@class='tags']/a/text()").extract(),
                    "author": data.xpath("span/small[@class='author']/text()").get(),
                    "quote": data.xpath("span[@class='text']/text()").get()}
